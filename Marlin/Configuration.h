...
#define STRING_CONFIG_H_AUTHOR "Ghost" // Original author or contributor.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 91.45
  #define DEFAULT_BED_KI 16.57
  #define DEFAULT_BED_KD 336.54
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE  83   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
  #define NOZZLE_PARK_Z_FEEDRATE   33   // (mm/s) Z axis feedrate (not used for delta printers)
#endif
